...
<?php 
    define("ROOT",$_SERVER['DOCUMENT_ROOT']."/PHP-MVC-02/Frontend/Publics/uploads/");
    /**
    * debug
    **/
    ...
    **/
    ...
    function base_url()
    {
        ...
        return $url  = "http://hoc-php.local/PHP-MVC-02"; 
    }

    function pages_frontend(){
        return base_url() . "/Frontend/Views/pages";
    }
    ...
    function uploads()
    {
        return base_url() . "/Frontend/publics/uploads/";
    }
