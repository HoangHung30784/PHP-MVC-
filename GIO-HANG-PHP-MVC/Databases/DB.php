...
class DB {
    ...
    public $con;
    protected $servername = config["severname"];
    protected $username = config["username"];
    protected $password = config["password"];
    protected $dbname = config["dbname"];


   //public $con;
    //protected $servername = "sql103.byethost.com";
   // protected $username = "b33_21247186";
   // protected $password = "toanhoc12345";
   // protected $dbname = "b33_21247186_phpmvc";
