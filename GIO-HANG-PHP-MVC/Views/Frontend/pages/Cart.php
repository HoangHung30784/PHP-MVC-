                            ...
                            <table class="table table-hover" style="text-align: left;" >
                            	...
                            	<tbody>
                            		...
                            		<tr>
                            			...
                            			<td>
                            				<img src="<?php echo __UPLOADS?>product/<?php echo $value['thumbar'] ?>" width=80px; height=80px;>                            					
                            			</td>
                            			<td>
                            			...
                            			<td>
                            				<a href="<?php echo base_url ?>/Cart/removeCart/<?php echo $key; ?>" class="btn btn-xs btn-danger"><i class="fa fa-remove"></i>Remove</a>
                            ...
                            <div class="col-md-5 pull-right" style="text-align: left;">
                            	<ul class="list-group">
                            		...
                            		<li class="list-group-item">
                            			...
                            			<a href="<?php echo base_url ?>/DonHang/thanhtoan" class="btn btn-success">Thanh toán</a>
