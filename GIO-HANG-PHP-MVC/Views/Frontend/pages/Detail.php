 ...
 ?>
                        ...
                        <section class="box-main1" >
                            <div class="col-md-6 text-center">
                                <img src="<?php echo __UPLOADS?>/product/<?php echo $product['thumbar'] ?>" class="img-responsive bor" id="imgmain" width="100%" height="370" data-zoom-image="images/16-270x270.png">
                                
                                <ul class="text-center bor clearfix" id="imgdetail">
                                    <li>
                                        <img src="<?php echo __PUBLICS?>/images/16-270x270.png" class="img-responsive pull-left" width="80" height="80">
                                    </li>
                                    <li>
                                        <img src="<?php echo __PUBLICS?>/images/16-270x270.png" class="img-responsive pull-left" width="80" height="80">
                                    </li>
                            ...
                            <div class="col-md-6 bor" style="margin-top: 20px;padding: 30px;">
                               <ul id="right">
                                    ...
                                    <li><a href="<?php echo base_url?>/Cart/addCart/<?php echo $product["id"]; ?>" class="btn btn-default"> <i class="fa fa-shopping-basket"></i>Add TO Cart</a></li>
                               </ul>
                            </div>
                        	...
                        	<div class="showitem">
                                        <?php foreach ($sanphamkemtheo as $item) { 
                                            ...
                                            <div class="col-md-3 item-product bor">
                                                ...
                                                <img src="<?php echo __UPLOADS?>/product/<?php echo $item['thumbar'] ?>" class="" width="100%" height="180">
                                                </a>
                                                <div class="info-item">
                                                    <a href="<?php echo base_url?>/Product/detail/<?php echo $item['id'] ?>"><?php echo $item['name'] ?></a>
                                                ...
                                                <div class="hidenitem">
                                                    ...
                                                    <p><a href="<?php echo base_url?>/Cart/addCart/<?php echo $item['id']; ?>"><i class="fa fa-shopping-basket"></i></a></p>
                                                </div>
                                            </div>
                                            <?php endif ?>
                                        <?php } ?>
